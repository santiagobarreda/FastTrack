...
procedure plotTableContext .sp, .tbl, .maximum_plotting_frequency, pointSize
  selectObject: .sp
  Line width: 1
  Paint: 0, 0, 0, 0, 100, "yes", 50, 6, 0, "yes"
  Marks left every: 1, 500, "yes", "yes", "yes"
  ...
  Magenta
  nocheck Scatter plot (mark): "time", viewstart, viewend, "f4", 0, .maximum_plotting_frequency, pointSize+0.2, "no", "o"
